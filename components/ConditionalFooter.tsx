        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-black hover:text-[#004A81] transition-colors duration-300">
                  Home
                </a>
              </li>
              <li>
                <a href="#about" className="text-black hover:text-[#004A81] transition-colors duration-300">
                  About
                </a>
              </li>
              <li>
                <a href="#services" className="text-black hover:text-[#004A81] transition-colors duration-300">
                  Services
                </a>
              </li>
              <li>
                <a href="#projects" className="text-black hover:text-[#004A81] transition-colors duration-300">
                  Projects
                </a>
              </li>
              <li>
                <a href="#contact" className="text-black hover:text-[#004A81] transition-colors duration-300">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-[#004A81] mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#004A81] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="text-gray-600 hover:text-[#004A81] transition-colors duration-300">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-600 hover:text-[#004A81] transition-colors duration-300">
                Terms of Service
